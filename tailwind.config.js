...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      // },
      boxShadow: {
        glow:         "0 0 15px 2px rgba(59, 130, 246, 0.3)",   // was 139,92,246
        "glow-strong":"0 0 20px 5px rgba(59, 130, 246, 0.5)",
        "inner-glow": "inset 0 0 15px 2px rgba(59, 130, 246, 0.2)",
      },
      backgroundImage: {
        "gradient-radial": "radial-gradient(var(--tw-gradient-stops))",
        "gradient-conic": "conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))",
        // "gradient-mesh": "linear-gradient(to right bottom, #8b5cf6, #6366f1, #3b82f6, #0ea5e9, #06b6d4)",
        "gradient-mesh": "linear-gradient(to right bottom, #2563eb, #3b82f6, #0ea5e9, #06b6d4)",
      },
    },
  },
  // In Tailwind v4:
