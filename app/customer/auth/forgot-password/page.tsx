...
export default function ForgotPasswordPage() {
  ...
  const [isSuccessfullySubmitted, setIsSubmitted] = useState(false)
  ...
  return (
    <div className="container mx-auto flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <Link href="/customer/auth/login" className="mb-6 flex items-center text-sm text-muted-foreground hover:text-foreground">
